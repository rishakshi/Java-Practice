...
public class GeniusStudent implements Comparable<GeniusStudent> {
	...
	public static void main(String[] args) {
		...
		GeniusStudent gst1 = new GeniusStudent(101, "Rishav", 45.6);
		GeniusStudent gst2 = new GeniusStudent(109, "Sachin", 55.4);
		GeniusStudent gst3 = new GeniusStudent(102, "Steve", 54.3);
		GeniusStudent gst4 = new GeniusStudent(105, "Anjali", 66.5);
		GeniusStudent gst5 = new GeniusStudent(105, "Ajali", 84.6);
